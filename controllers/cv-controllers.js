...
export const updateEducation = async (req, res, next) => {
  ...
  education.collegeMajor = collegeMajor;
  education.collegeQualification = collegeQualification;
  education.schoolName = schoolName;
  education.schoolMajor = schoolMajor;
  education.schoolQualification = schoolQualification;
